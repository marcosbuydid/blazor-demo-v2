...
namespace DataAccess
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Seed Data
            modelBuilder.Entity<Student>().HasData(new Student { Id = 1, Name = "Student Name", StudentId = 216743 });
            modelBuilder.Entity<Professor>().HasData(new Professor { Id = 2, Name = "Professor Name", Salary = 10000 });
        }*/
